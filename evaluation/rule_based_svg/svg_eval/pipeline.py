"""End-to-end standalone SVG raw-IR, diff, and semantic-IR pipeline."""
...
from .runtime import SVGBrowserRuntime
...
def extract_diffed_svg_bundle(
    candidate_file: str | Path,
    baseline_file: str | Path,
    *,
    candidate_screenshot: str | Path | None = None,
    baseline_screenshot: str | Path | None = None,
    runtime: SVGBrowserRuntime | None = None,
) -> dict:
    """Render two SVG documents and return raw, delta, and semantic IR artifacts."""

    owns_runtime = runtime is None
    if owns_runtime:
        runtime = SVGBrowserRuntime()
        runtime.__enter__()
